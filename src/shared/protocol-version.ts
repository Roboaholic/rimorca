...
export const GITLAB_EXPLICIT_PROJECT_RUNTIME_CAPABILITY = 'gitlab.explicit-project.v1' as const
...
export const FOLDER_WORKSPACE_REPO_DERIVE_RUNTIME_CAPABILITY =
  'folder-workspace.repo-derive.v1' as const
...
export const RUNTIME_CAPABILITIES = [
  ...
  GITLAB_EXPLICIT_PROJECT_RUNTIME_CAPABILITY,
